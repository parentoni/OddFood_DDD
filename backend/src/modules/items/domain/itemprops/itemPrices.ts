...
type ItemPricesResponse = Promise<Either<CommonUseCaseResult.InvalidValue | CommonUseCaseResult.UnexpectedError, ItemPrices>>
...
export class ItemPrices extends ValueObject<Price[]>{
    ...
    public static async create( props : Price[]) : ItemPricesResponse {
