...
export type RepositoryBaseResult<U> = Promise<Either<CommonUseCaseResult.InvalidValue | CommonUseCaseResult.UnexpectedError | GenericError<IBaseError>, U>>;
export type RepositorySaveResult<U> = Promise<Either<CommonUseCaseResult.UnexpectedError | GenericError<IBaseError>, boolean>>;
