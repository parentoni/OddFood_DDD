...
export const EmptyCartContainer = () => {
    ...
    return (
        <div className="w-full rounded-lg flex px-4 items-center  flex-col justify-center my-2 h-[70%] bg-gray-100">
            ...
            <h1 className='text-3xl font-semibold text-center'>Seu carrinho está vazio</h1>
            <p className='text-xl font-semibold text-center'>Volte para a página inicial para fazer um pedido</p>
